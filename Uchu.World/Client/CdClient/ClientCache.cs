...
namespace Uchu.World.Client
{
    ...
    public static class ClientCache
    {
        ...
        /// </summary>
        public static Uchu.Core.Client.CurrencyTable[] CurrencyTableTable { get; private set; }
        ...
        /// </summary>
        public static Uchu.Core.Client.LootMatrix[] LootMatrixTable { get; private set; }
        ...
        public static async Task LoadAsync()
        {
            ...
            LootMatrixTable = cdContext.LootMatrixTable.ToArray();
