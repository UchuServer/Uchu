    ...
    public class Item : GameObject
    {
        ...
        protected Item()
        {
            ...
            Listen(OnStart, () =>
            {
                ...
                var skills = ClientCache.ObjectSkillsTable.Where(
        ...
        public ItemComponent ItemComponent
        {
            get
            {
                ...
                return ClientCache.ItemComponentTable.FirstOrDefault(c => c.Id == id);
            }
        }
        ...
        public static Item Instantiate(long itemId, Inventory inventory)
        {
            ...
            var cdClientObject = ClientCache.ObjectsTable.FirstOrDefault(
                o => o.Id == item.Lot
            );
